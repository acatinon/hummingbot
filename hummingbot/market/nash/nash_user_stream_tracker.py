...
from hummingbot.market.nash.nash_api_user_stream_data_source import NashAPIUserStreamDataSource
from hummingbot.market.nash.nash_auth import NashAuth


class NashUserStreamTracker(UserStreamTracker):
    ...
    def __init__(
        ...
        self._nash_auth: NashAuth = nash_auth

    @property
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            if self._data_source_type is UserStreamTrackerDataSourceType.EXCHANGE_API:
                self._data_source = NashAPIUserStreamDataSource(nash_auth=self._nash_auth)
            else:
